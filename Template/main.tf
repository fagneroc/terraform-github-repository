provider "github" {
  ...
  owner = "My-Organization-Name" ## Change My-Organization-Name to the name of your organization on GitHub
}
...
## Uncomment if you want to create Codeowners permission file
...
# Uncomment if you want to create a webhook
